...
const BestSeller = () => {
  ...
  return (
    <>
      <div className="w-[80%] mx-auto mt-8 pb-2">
        <div className="">
        ...
        <div className="flex justify-between overflow-x-auto gap-8  ">
          {seller.map((box, idx) => {
            return (
              <div key={idx} className=" pt-8 pb-1 max-lg:pt-4 ">
                <div className="  bg-[#1c1816] w-[290px] h-[360px] rounded max-md-w-[100%] ">
                  ...
                  <div className="">
                    <h2 className="my-2 ml-2 text-[white] font-bold text-2xl">
                      {box.name}
                    </h2>
                  </div>
                  <div className="flex justify-end ">
                    <p className="bg-[#ea002a] text-[white] px-2 font-bold text-xl">
